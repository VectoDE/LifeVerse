    ...
    async execute(interaction: ChatInputCommandInteraction) {
        try {
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields(
                    { name: "Invite Link", value: botInviteLink, inline: true }
                )
                .setTimestamp();
            ...
            await interaction.reply({ content: "❌ An error occurred while generating the invite link. Please try again later.", ephemeral: true });
        }
    },
};
