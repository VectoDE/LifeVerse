...
const ServerInfoCommand: Command = {
    ...
    async execute(interaction: ChatInputCommandInteraction) {
        try {
            ...
            if (!guild) {
                await interaction.reply({ content: "❌ Couldn't fetch server information.", ephemeral: true });
                return;
            }
            ...
            const embed = new EmbedBuilder()
                ...
                .addFields(
                    ...
                    { name: "🗓️ Server Created", value: createdAt, inline: true },
                    ...
                    { name: "😀 Emojis Count", value: `${emojisCount}`, inline: true }
                )
                .setTimestamp();
